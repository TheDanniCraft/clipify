...
colors:
  dark:
    ...
    snow: "#FCFCFC"
    white: "#FFFFFF"
    accent-soft-hover: "rgba(95, 6, 245, 0.16)"
    background-inverse: "#FCFCFC"
    background-secondary: "#141414"
    background-tertiary: "#191919"
    ...
    success-foreground: "#161917"
    success-hover: "#16B665"
    success-soft: "rgba(0, 202, 110, 0.12)"
    success-soft-foreground: "#72D995"
    success-soft-hover: "rgba(0, 202, 110, 0.16)"
  ...
  light:
    ...
    accent-foreground: "#FCFCFC"
    accent-hover: "#693EF8"
    accent-soft: "rgba(95, 6, 245, 0.15)"
    accent-soft-foreground: "#4623AE"
    danger: "#ED2945"
    success: "#00CA6E"
    warning: "#F09500"
    border: "#DEDEDE"
    ...
    snow: "#FCFCFC"
    white: "#FFFFFF"
    accent-soft-hover: "rgba(95, 6, 245, 0.2)"
    background-inverse: "#18181B"
    background-secondary: "#F0F0F0"
    background-tertiary: "#E8E8E9"
    border-secondary: "#C6C6C7"
    border-tertiary: "#A8A8A9"
    danger-foreground: "#FCFCFC"
    danger-hover: "#F24A57"
    danger-soft: "rgba(237, 41, 69, 0.15)"
    danger-soft-foreground: "#9A2D37"
    danger-soft-hover: "rgba(237, 41, 69, 0.2)"
    ...
    success-foreground: "#161917"
    success-hover: "#16B665"
    success-soft: "rgba(0, 202, 110, 0.15)"
    success-soft-foreground: "#29784A"
    success-soft-hover: "rgba(0, 202, 110, 0.2)"
    surface-foreground: "#18181B"
    surface-hover: "#EAEAEA"
    surface-secondary-foreground: "#18181B"
    surface-tertiary-foreground: "#18181B"
    warning-foreground: "#18181B"
    warning-hover: "#D88716"
    warning-soft: "rgba(240, 149, 0, 0.15)"
    warning-soft-foreground: "#835827"
    warning-soft-hover: "rgba(240, 149, 0, 0.2)"
typography:
  xs:
    fontFamily: "Inter"
    fontSize: "12px"
...
components:
  button-danger:
    backgroundColor: "#ED2945"
    component: 'Button variant="danger"'
    textColor: "#FCFCFC"
  button-primary:
    backgroundColor: "#5F06F5"
...
| `background`                   | `#F5F5F5`                  | `#101010`                  | `Light: oklch(97.02% 0.0001 263.28); Dark: oklch(17.30% 0.0000 263.28)`           | `--background`                   | `bg-background`                                                            | Page-level base canvas. The foundational background of the interface.                            |
...
| `muted`                        | `#727272`                  | `#A0A0A0`                  | `Light: oklch(55.17% 0.0000 284.36); Dark: oklch(70.50% 0.0000 284.36)`           | `--muted`                        | `text-muted`                                                               | Secondary text color for less prominent content like placeholders and captions.                  |
| `overlay`                      | `#FFFFFF`                  | `#181818`                  | `Light: = white; Dark: oklch(21.03% 0.0000 284.36)`                               | `--overlay`                      | `bg-overlay text-overlay-foreground` for floating panels                   | Background for modals, popovers, and floating panels.                                            |
| `surface`                      | `#FFFFFF`                  | `#181818`                  | `Light: = white; Dark: oklch(21.03% 0.0000 284.36)`                               | `--surface`                      | `bg-surface text-surface-foreground` for cards and panels                  | Container background for cards, panels, modals, and dropdowns.                                   |
| `surface-secondary`            | `#EFEFEF`                  | `#232323`                  | `Light: oklch(95.24% 0.0000 284.36); Dark: oklch(25.70% 0.0000 284.36)`           | `--surface-secondary`            | `bg-surface-secondary` for subdued nested surfaces                         | Secondary surface for nested containers and layered panels.                                      |
| `surface-tertiary`             | `#EAEAEA`                  | `#272727`                  | `Light: oklch(93.73% 0.0000 284.36); Dark: oklch(27.21% 0.0000 284.36)`           | `--surface-tertiary`             | `bg-surface-tertiary` for low-emphasis nested surfaces                     | Tertiary surface for deeper nesting levels.                                                      |
| `accent`                       | `#5F06F5`                  | `#5F06F5`                  | `oklch(48.80% 0.2839 284.35)`                                                     | `--accent`                       | `Button variant="primary"` or `bg-accent text-accent-foreground`           | Primary brand color. Used for key actions, highlights, and moments of emphasis.                  |
| `accent-foreground`            | `#FCFCFC`                  | `#FCFCFC`                  | `oklch(99.11% 0.0000 0.00)`                                                       | `--accent-foreground`            | `text-accent-foreground` on accent surfaces                                | Text/icon color on accent backgrounds. Optimized for contrast and readability.                   |
...
| `danger`                       | `#ED2945`                  | `#F31260`                  | `Light: oklch(61.31% 0.2258 20.68); Dark: oklch(61.93% 0.2419 11.32)`             | `--danger`                       | `Button variant="danger"` or `text-danger` for destructive states          | Represents destructive, irreversible, or critical actions and states.                            |
...
| `warning`                      | `#F09500`                  | `#F5A524`                  | `Light: oklch(74.65% 0.1645 67.39); Dark: oklch(78.19% 0.1584 72.32)`             | `--warning`                      | `text-warning` for caution states                                          | Indicates caution or actions that require attention but are not destructive.                     |
...
| `scrollbar`                    | `#D4D4D4`                  | `#A0A0A0`                  | `Light: oklch(87.10% 0.0000 284.36); Dark: oklch(70.50% 0.0000 284.36)`           | `--scrollbar`                    | Scrollbar thumb color                                                      | Scrollbar thumb color.                                                                           |
| `segment`                      | `#FFFFFF`                  | `#474747`                  | `Light: = white; Dark: oklch(39.64% 0.0000 284.36)`                               | `--segment`                      | Segmented controls                                                         | Background for segmented controls.                                                               |
| `separator`                    | `#E4E4E4`                  | `#222222`                  | `Light: oklch(92.00% 0.0000 284.36); Dark: oklch(25.00% 0.0000 284.36)`           | `--separator`                    | `border-separator` or HeroUI `Separator`                                   | Divider color for structuring content with subtle boundaries.                                    |
| `field-background`             | `#FFFFFF`                  | `#181818`                  | `Light: = white; Dark: oklch(21.03% 0.0000 284.36)`                               | `--field-background`             | Use HeroUI field components rather than custom backgrounds                 | Background for text inputs, selects, and interactive fields.                                     |
...
| `field-border`                 | `#DEDEDE`                  | `#292929`                  | `Light: oklch(90.00% 0.0000 284.36); Dark: oklch(28.00% 0.0000 284.36)`           | `--field-border`                 | Use HeroUI field components or `border-field-border` for custom fields     | Border color for form fields. Transparent by default.                                            |
...
| `chart-1`                      | `#3300A0`                  | `#3300A0`                  | `oklch(from var(--accent) calc(l - 0.24) c h)`                                    | `--chart-1`                      | First chart series color                                                   | Chart series color 1. Darkest accent-derived shade for multi-series visualizations.              |
| `chart-2`                      | `#4600CA`                  | `#4600CA`                  | `oklch(from var(--accent) calc(l - 0.12) c h)`                                    | `--chart-2`                      | Second chart series color                                                  | Chart series color 2. Mid-dark accent-derived shade.                                             |
| `chart-3`                      | `#5F06F5`                  | `#5F06F5`                  | `= accent`                                                                        | `--chart-3`                      | Primary chart series color, aligned with accent                            | Chart series color 3. Equal to accent — the brand baseline.                                      |
| `chart-4`                      | `#7C4DFF`                  | `#7C4DFF`                  | `oklch(from var(--accent) calc(l + 0.12) c h)`                                    | `--chart-4`                      | Fourth chart series color                                                  | Chart series color 4. Mid-light accent-derived tint.                                             |
| `chart-5`                      | `#9D7AFF`                  | `#9D7AFF`                  | `oklch(from var(--accent) calc(l + 0.24) c h)`                                    | `--chart-5`                      | Fifth chart series color                                                   | Chart series color 5. Lightest accent-derived tint.                                              |
...
| `accent-soft-hover`            | `rgba(95, 6, 245, 0.2)`    | `rgba(95, 6, 245, 0.16)`   | `Light: accent / 20% + transparent; Dark: accent / 16% + transparent`             | `--accent-soft-hover`            | Prefer the HeroUI token for accent-soft-hover.                             | Hover state for accent-soft backgrounds.                                                         |
...
| `background-secondary`         | `#F0F0F0`                  | `#141414`                  | `background / 98% + foreground / 2%`                                              | `--background-secondary`         | Prefer the HeroUI token for background-secondary.                          | Slightly tinted background for subtle contrast against the base canvas.                          |
...
| `danger-hover`                 | `#F24A57`                  | `#F8416F`                  | `danger / 90% + danger-foreground / 10%`                                          | `--danger-hover`                 | Prefer the HeroUI token for danger-hover.                                  | Hover state for danger backgrounds.                                                              |
| `danger-soft`                  | `rgba(237, 41, 69, 0.15)`  | `rgba(243, 18, 96, 0.15)`  | `danger / 15% + transparent`                                                      | `--danger-soft`                  | Prefer the HeroUI token for danger-soft.                                   | Subtle danger background for soft emphasis.                                                      |
| `danger-soft-foreground`       | `#9A2D37`                  | `#FE6E89`                  | `Light: danger / 70% + foreground / 40%; Dark: danger / 80% + foreground / 30%`   | `--danger-soft-foreground`       | Prefer the HeroUI token for danger-soft-foreground.                        | Text color on danger-soft backgrounds.                                                           |
| `danger-soft-hover`            | `rgba(237, 41, 69, 0.2)`   | `rgba(243, 18, 96, 0.2)`   | `danger / 20% + transparent`                                                      | `--danger-soft-hover`            | Prefer the HeroUI token for danger-soft-hover.                             | Hover state for danger-soft backgrounds.                                                         |
...
| `success-foreground`           | `#161917`                  | `#161917`                  | `oklch(21.03% 0.0059 154.47)`                                                     | `--success-foreground`           | Prefer the HeroUI token for success-foreground.                            | Text/icon color on success backgrounds.                                                          |
| `success-hover`                | `#16B665`                  | `#16B665`                  | `success / 90% + success-foreground / 10%`                                        | `--success-hover`                | Prefer the HeroUI token for success-hover.                                 | Hover state for success backgrounds.                                                             |
| `success-soft`                 | `rgba(0, 202, 110, 0.15)`  | `rgba(0, 202, 110, 0.12)`  | `Light: success / 15% + transparent; Dark: success / 12% + transparent`           | `--success-soft`                 | Prefer the HeroUI token for success-soft.                                  | Subtle success background for soft emphasis.                                                     |
| `success-soft-foreground`      | `#29784A`                  | `#72D995`                  | `Light: success / 80% + foreground / 60%; Dark: success / 80% + foreground / 30%` | `--success-soft-foreground`      | Prefer the HeroUI token for success-soft-foreground.                       | Text color on success-soft backgrounds.                                                          |
| `success-soft-hover`           | `rgba(0, 202, 110, 0.2)`   | `rgba(0, 202, 110, 0.16)`  | `Light: success / 20% + transparent; Dark: success / 16% + transparent`           | `--success-soft-hover`           | Prefer the HeroUI token for success-soft-hover.                            | Hover state for success-soft backgrounds.                                                        |
...
| `warning-hover`                | `#D88716`                  | `#DC962A`                  | `warning / 90% + warning-foreground / 10%`                                        | `--warning-hover`                | Prefer the HeroUI token for warning-hover.                                 | Hover state for warning backgrounds.                                                             |
| `warning-soft`                 | `rgba(240, 149, 0, 0.15)`  | `rgba(245, 165, 36, 0.12)` | `Light: warning / 15% + transparent; Dark: warning / 12% + transparent`           | `--warning-soft`                 | Prefer the HeroUI token for warning-soft.                                  | Subtle warning background for soft emphasis.                                                     |
| `warning-soft-foreground`      | `#835827`                  | `#F8BE72`                  | `Light: warning / 80% + foreground / 70%; Dark: warning / 80% + foreground / 30%` | `--warning-soft-foreground`      | Prefer the HeroUI token for warning-soft-foreground.                       | Text color on warning-soft backgrounds.                                                          |
| `warning-soft-hover`           | `rgba(240, 149, 0, 0.2)`   | `rgba(245, 165, 36, 0.16)` | `Light: warning / 20% + transparent; Dark: warning / 16% + transparent`           | `--warning-soft-hover`           | Prefer the HeroUI token for warning-soft-hover.                            | Hover state for warning-soft backgrounds.                                                        |
