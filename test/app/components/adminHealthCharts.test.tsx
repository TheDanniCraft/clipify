...
const healthSnapshot: InstanceHealthSnapshot = {
	...
	billing: {
		...
		runnerSubscriptionsActive: 2,
		runnerSubscriptionsPastDue: 0,
		runnerSubscriptionsCanceling: 1,
		runnerMonthlyRecurringRevenueCents: 600,
		runnerAnnualRecurringRevenueCents: 6000,
	},
	runners: {
		total: 3,
		online: 2,
		offline: 1,
		owners: 2,
		streamSessionsTotal: 2,
		streamsDesiredRunning: 2,
		streamsActuallyRunning: 1,
		streamsErrored: 1,
		byOs: { linux: 2, windows: 1 },
		byVersion: { latest: 2, old: 1 },
		byMode: { "24/7": 1, failsafe: 1 },
		byDestination: { youtube: 1, twitch: 1, custom: 0 },
		byModeAndDestination: {
			"24/7": { youtube: 1, twitch: 0, custom: 0 },
			failsafe: { youtube: 0, twitch: 1, custom: 0 },
		},
	},
	cache: {
		entriesTotal: 1000,
