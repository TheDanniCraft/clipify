...
export const c15t_subjectRelations = relations(c15t_subject, ({ many }) => ({
...
export const c15t_domainRelations = relations(c15t_domain, ({ many }) => ({
	consents: many(c15t_consent, {
...
export const c15t_consentPolicyRelations = relations(c15t_consentPolicy, ({ many }) => ({
	consents: many(c15t_consent, {
...
export const c15t_runtimePolicyDecisionRelations = relations(c15t_runtimePolicyDecision, ({ many }) => ({
	consents: many(c15t_consent, {
...
export const c15t_consent = pgTable(
	"c15t_consent",
	{
		id: varchar("id", { length: 255 }).primaryKey().notNull(),
...
export const c15t_consentRelations = relations(c15t_consent, ({ one }) => ({
...
export const c15t_auditLog = pgTable(
	"c15t_auditLog",
	{
		id: varchar("id", { length: 255 }).primaryKey().notNull(),
...
export const c15t_auditLogRelations = relations(c15t_auditLog, ({ one }) => ({
	subject: one(c15t_subject, {
		relationName: "auditLog_subject",
