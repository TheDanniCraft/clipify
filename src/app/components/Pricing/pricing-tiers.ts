...
export const tiers: Array<Tier> = [
	{
		...
		features: ["Unlimited clips", "One overlay", "One playlist (up to 50 clips)", "Playlist overlay type", "Manual playlist curation", "Plug & Play setup", "Random playback mode", "Basic clip filtering", "Keeps your stream entertained", "Basic clip player for embedding in websites"],
