...
export const tiers: Array<Tier> = [
	...
	},
	{
		...
		features: [
			...
			"Playback modes: Random, Top, Hybrid",
			"Prefer current category + clip creator filters",
			"Theme Studio with drag & drop layout",
			"Custom colors, fonts, borders, and effects",
			"Timer, progress bar, and player volume controls",
