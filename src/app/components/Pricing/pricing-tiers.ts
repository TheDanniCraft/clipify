...
export const tiers: Array<Tier> = [
	{
		...
		features: ["Unlimited clips", "One overlay", "Plug & Play setup", "Control which clips play", "Keeps your stream entertained", "Basic clip player for embedding in websites"],
	...
	},
	{
		...
		featured: false,
		features: ["Everything in Free", "Multiple overlays", "Channel points integration", "Priority support", "Control your overlay via chat", "Advanced clip player for embedding in websites", "Add editors to manage your overlays", "Advanced clip filtering", "Access to beta features", "Access to all upcoming features", "Support an independent developer"],
