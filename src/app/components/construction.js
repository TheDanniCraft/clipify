    ...
    return (
        <div className="min-h-screen min-w-screen flex items-center justify-center bg-gradient-to-br from-primary-800 to-primary-400">
            <div className="flex flex-col items-center">
                ...
                <motion.p
                    className="text-default-600 text-lg mb-8"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                {endDate && (
                    <div className="flex gap-4 mb-12 justify-center">
                        {["days", "hours", "minutes", "seconds"].map((key, i) => (
                            <motion.div
                                key={key}
                                className="bg-foreground border shadow-md px-5 py-3 rounded-lg text-center flex flex-col items-center"
                                custom={i}
                                initial={{ opacity: 0, x: 15 }}
                                animate={{ opacity: 1, x: 0 }}
                                transition={{ delay: 0.6 + (i * 0.2), duration: 0.1 }}
                                style={{ width: '80px' }}
                            >
                                <motion.div
                        ...
                        <PopoverContent className="p-5 w-[300px] min-w-[300px]">
                            <Form onSubmit={subscribe}>
                                <Input
                                    ...
                                    onChange={() => { setNewsletterState('defult') }}
                                    name='email'
                ...
                <motion.footer
                    className="mt-5 text-sm text-default-500"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ delay: 0.9 + (endDate ? 0.3 : 0), duration: 0.5 }}
                >
