	...
	return (
		<>
			<div className='min-h-screen bg-background text-foreground'>
				<div className='border-b border-default bg-background'>
					...
					<div className='mx-auto grid max-w-4xl items-end gap-6 px-6 pb-10 pt-10 sm:grid-cols-[1fr_auto] sm:pt-12'>
						<div className='space-y-4'>
							...
							<p className='max-w-2xl text-base text-muted sm:text-lg'>Provider information in accordance with Section 5 German Telemedia Act (TMG).</p>
						</div>
