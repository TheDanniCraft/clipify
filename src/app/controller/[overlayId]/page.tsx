	...
	return (
		<main className='min-h-screen bg-background px-6 py-12'>
			<div className='mx-auto flex min-h-[calc(100vh-6rem)] w-full max-w-3xl items-center justify-center'>
				<div className='w-full rounded-[32px] border border-default bg-surface p-8 shadow-sm'>
					...
					{ctaLabel && ctaHref ? (
						<div className='mt-6 flex justify-center'>
							<Link href={ctaHref} className='inline-flex h-11 items-center rounded-full bg-accent px-5 text-sm font-semibold text-white transition hover:opacity-90'>
								{ctaLabel}
							</Link>
						</div>
					) : null}
