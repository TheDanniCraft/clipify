	...
	},
	{
		...
		rules: {
			"no-restricted-syntax": [
				"error",
				{
					selector: "ExportNamedDeclaration > FunctionDeclaration[id.name=/.*Internal$/], ExportNamedDeclaration > VariableDeclaration > VariableDeclarator[id.name=/.*Internal$/], ExportSpecifier[exported.name=/.*Internal$/]",
